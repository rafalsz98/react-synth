...
export default function DaftPunk() {
    ...
    return (
        <Track bpm={113}>
            ...
            {/* 2. The High-Hat / Click Track */}
            <Loop id="click" sync="kick" interval={1}>
                <Loop times={4} interval={0.25}>
            ...
            <Loop id="giorgio_arp" interval={16}>
                <Synth type="prophet">
                    {progression.map((root, chordIndex) => (
                        <Loop key={root} times={16} interval={0.25} delay={chordIndex * 4}>
                            <Note
                                pattern={[root, `${root}+12`, `${root}+7`, `${root}+12`]}
            ...
            <Loop id="pads" interval={16}>
                <Effect type="reverb" room={0.8}>
                    <Synth type="hollow">
                        <Chord notes={['a3', 'c4', 'e4']} release={4} amp={0.5} delay={0} />
                        <Chord notes={['g3', 'b3', 'd4']} release={4} amp={0.5} delay={4} />
                        <Chord notes={['f3', 'a3', 'c4']} release={4} amp={0.5} delay={8} />
                        <Chord notes={['e3', 'g3', 'b3']} release={4} amp={0.5} delay={12} />
                    </Synth>
                </Effect>
            </Loop>
        </Track>
